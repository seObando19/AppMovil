...
public class ProyectoAppPushNotification extends FirebaseMessagingService {
    @Override
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if(remoteMessage.getData().size() > 0 && remoteMessage.getNotification() != null)
        {
            ...
            crearNotificacion(title, body);
        }
    }
    private void crearNotificacion(String title, String body)
    {
